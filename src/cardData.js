...
export const CARD_DATABASE = {
  ...
  'Spiced Ham': { name: 'Spiced Ham', flavor: -1, yuck: 0, cash: 0, cost: 11, category: 'Meat', ability: 'Next card +1 flavor (permanent)', imageFile: 'spiced-ham.png' },
  ...
  'Peanut Butter': { name: 'Peanut Butter', flavor: 1, yuck: 0, cash: 0, cost: 12, ability: '+1 flavor permanently if next to Jelly', imageFile: 'peanut-butter.png' },
  'Lean Beef': { name: 'Lean Beef', flavor: 1, yuck: 0, cash: 0, cost: 12, category: 'Meat', ability: 'Flavor doubles per beef', imageFile: 'lean-beef.png' },
  ...
  'Pickles': { name: 'Pickles', flavor: 2, yuck: 0, cash: 0, cost: 10, ability: 'Flavor increases quadratically for each yuck', imageFile: 'pickles.png' },
