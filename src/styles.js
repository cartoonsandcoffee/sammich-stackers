...
export const styles = {
  ...
  // Tooltip
  tooltip: "absolute z-[9999] bg-chalkboard text-milk-carton text-xs rounded-xl p-3 -top-38 left-0 w-64 shadow-tray opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none border-3 border-milk-carton",
